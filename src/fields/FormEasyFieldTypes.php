...
namespace formeasy\form\fields;

use formeasy\form\Form;
use formeasy\form\assetbundles\formeasyfieldtypesfield\FormEasyFieldTypesFieldAsset;
 ...
 * @since     1.0.0
 */
class FormEasyFieldTypes extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('form', 'FormEasyFieldTypes');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'form/_components/fields/FormEasyFieldTypes_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(FormEasyFieldTypesFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').FormFormEasyFieldTypes(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'form/_components/fields/FormEasyFieldTypes_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
