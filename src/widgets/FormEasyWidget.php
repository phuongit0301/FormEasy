...
namespace formeasy\form\widgets;

use formeasy\form\Form;
use formeasy\form\assetbundles\formeasywidgetwidget\FormEasyWidgetWidgetAsset;
 ...
 * @since     1.0.0
 */
class FormEasyWidget extends Widget
{
    ...
    {
        return Craft::t('form', 'FormEasyWidget');
    }
    ...
    {
        return Craft::getAlias("@formeasy/form/assetbundles/formeasywidgetwidget/dist/img/FormEasyWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'form/_components/widgets/FormEasyWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(FormEasyWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'form/_components/widgets/FormEasyWidget_body',
            [
